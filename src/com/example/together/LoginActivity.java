...
public class LoginActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		context = this;
		src = (String) getIntent().getSerializableExtra("SRC");
		initUI();
...
//		sina = (TextView) findViewById(R.id.login_sina);
//		tecent = (TextView) findViewById(R.id.login_tecent);
	...
	private void setClickListener() {
		...
		tecent.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
			}
		});
